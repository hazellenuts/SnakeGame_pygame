...
class FRUIT:
    ...
    def draw_fruit(self):
        fruit_rect = pygame.Rect(int(self.pos.x*cell_size + (cell_size - apple.get_width()) / 2),int(self.pos.y*cell_size + (cell_size - apple.get_width()) / 2),cell_size,cell_size)
...
class MAIN:
    ...
    def draw_score(self):
        ...
        applectr_rect = apple_counter.get_rect(midright = (score_rect.left,score_rect.centery-2))
        
        screen.blit(score_surface,score_rect)
        screen.blit(apple_counter,applectr_rect)
...
apple_counter = pygame.image.load('assets/apple_counter.png').convert_alpha()
game_font = pygame.font.Font('fonts/dogicabold.ttf', 25)
